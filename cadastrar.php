...
if($btnCadUsuario){
	...
	if(!$erro){
		...
		$result_usuario = "INSERT INTO usuarios (nome, email, telefone, usuario, senha) VALUES (
						'" .$dados['nome']. "',
						'" .$dados['email']. "',
						'".$dados['telefone']."',
						'" .$dados['email']. "',
		...
		<div class="container">
			<div class="form-signin" style="background: #42dea4;">
				...
				<form method="POST" action="">
					...
					<input type="text" id="nome" name="nome" placeholder="Digite o nome e o sobrenome" class="form-control"><br>
					
					<label for="email">E-mail</label>
					<input type="text" id="email" name="email" placeholder="Digite o seu e-mail" class="form-control"><br>

                    <label for="telefone">Telefone de contato</label>
                    <input type="text" id="telefone" name="telefone" placeholder="Digite telefone para contato" class="form-control"><br>

                    <label for="senha">Senha</label>
					<input type="password" id="senha" name="senha" placeholder="Digite a senha" class="form-control"><br>
